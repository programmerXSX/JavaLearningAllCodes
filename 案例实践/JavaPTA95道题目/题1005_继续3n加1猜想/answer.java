package JavaPTA95道题目.题1005_继续3n加1猜想;

import JavaPTA95道题目.题1001_害死人不偿命的3n加1猜想.Answer;
...
public class answer {
	public static void main(String[] args) {
		...
		Set<Integer> numberAnswer = new TreeSet<>(new Comparator<Integer>() {
			@Override
		...
		for (int i = 0; i < length; i++) {
			if (!numberMap.containsValue(numbers[i])){
				numberAnswer.add(numbers[i]);
			}
		}
		for(Integer i:numberAnswer){
			System.out.print(i + " ");
		}
		sc.close();
	}
